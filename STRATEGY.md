...
`Command` / HTTP API / CLI / AiScript / AI Tool calling の **5 経路が同一の Capability Registry を共有** する設計。コマンドパレットに追加したものが即 AI ツールにも公開される。70+ 個の builtin (notes / column / account / memos / theme / skills / widgets / plugins / ai / meta / clipboard / drive / http / time / user / notifications / tasks / ui / misstore / logs) を備える。
