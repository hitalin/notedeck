...
fn run_inner() -> Result<(), Box<dyn std::error::Error>> {
    ...
    builder = builder.invoke_handler(tauri::generate_handler![
        ...
        commands::api_get_guest_timeline,
        commands::api_get_user_public,
        commands::api_get_user_detail_public,
        commands::api_get_user_notes_public,
        commands::api_get_note_public,
