...
pub fn build_specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![
            ...
            commands::api_create_drive_folder,
            commands::api_update_drive_folder,
            commands::api_delete_drive_folder,
            commands::api_update_drive_file,
            commands::api_move_drive_files,
