...
pub fn set_window_vibrancy(
    ...
    #[allow(unused_variables)] effect: String,
) -> Result<()> {
    #[cfg(desktop)]
    {
...
#[tauri::command]
pub fn clear_window_vibrancy(
    #[allow(unused_variables)] window: tauri::WebviewWindow,
) -> Result<()> {
    #[cfg(desktop)]
    {
        window.set_effects(None).map_err(|e| {
            NoteDeckError::InvalidInput(format!("Failed to clear window effects: {e}"))
        })
    }
