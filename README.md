...
タイムライン・通知・検索・リスト・アンテナ・お気に入り・クリップ・チャンネル・あなた宛て・ダイレクト・チャット・ユーザー・ウィジェット・AiScript・Play・Pages・お知らせ・ドライブ・ギャラリー・実績・フォローリクエスト・Explore の 22 種類のカラムをドラッグ＆ドロップで好きなように並べられます。幅も自由にリサイズ可能。
