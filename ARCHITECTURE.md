...
| 2 | `maxLiveColumns` + shell / snapshot / live の hydration state machine | 未着手 | Phase 2 として実装 |
| 3 | initial hydration の batch 化 | 未着手 | Phase 2 完了後に計測して判断 |
| 4 | Read Model / fine-grained invalidation | 未着手 | 計測ベースで判断（Phase 3） |
| 5 | lightweight first paint の拡張 | 未着手 | ボトルネックが IPC/API から移った場合のみ |
