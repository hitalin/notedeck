...
- [ ] **Obsidian 連携** — ノートメニュー →「Obsidian に送る」で Obsidian URI 経由で直接保存。
  Obsidian Vault のパス設定のみで連携完了
- [ ] **Logseq 連携** — Logseq のグラフディレクトリに Markdown を直接書き出し
...
- [ ] **AI 要約エクスポート** — 検索結果や TL を AI が要約し、Obsidian / Logseq に Markdown で書き出し
...
| 優先度 | やること | Layer | 理由 |
|--------|----------|-------|------|
| **今すぐ** | Markdown エクスポート + Obsidian 連携 | L3 | フロンティアの最初のピース。外部 PKM への橋渡し |
