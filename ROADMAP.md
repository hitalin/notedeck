...
- [x] **Misskey Plugin API 互換** — `Plugin:register_note_action`, `Plugin:register_post_form_action`,
  `Plugin:register_note_view_interruptor`, `Plugin:register_note_post_interruptor` を実装。
